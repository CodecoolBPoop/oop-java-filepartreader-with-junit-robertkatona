...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        FilePartReader fpr = new FilePartReader("/Users/katonarobert/IdeaProjects/oop-java-filepartreader-with-junit-robertkatona/src/example.txt");
        System.out.println(fpr.setup(fpr.getFromLine(), fpr.getToLine()));
        ...
        System.out.println(exampleSubString);
